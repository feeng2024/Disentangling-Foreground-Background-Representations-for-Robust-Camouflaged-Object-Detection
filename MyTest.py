...
if __name__ == '__main__':
    ...
    parser.add_argument('--snap_path', type=str, default='./Checkpoints/MVGNet_v10_test0504/Net_epoch_best_55_to_59.pth',
                        help='train use gpu')
    ...
    #for data_name in ['DUT-O', 'DUTS-TE', 'ECSSD','HKU-IS','PASCAL-S']:
        ...
        evaluator(
            ...
            #val_root='./Dataset/SOD_Test/' + data_name + '/',
            map_save_path=map_save_path,
            edge_save_path=edge_save_path,
            trainsize=384)#trainsize=416
